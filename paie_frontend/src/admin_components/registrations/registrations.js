      ...
      await axios
        ...
        `;
            window.Email.send({
              ...
              message === "OK" ? window.location.reload(3) : alert(message)
            );
          } else {
            // alert("Try again");
      ...
      await axios.post("http://localhost:8000/verify/" + gmail).then((res1) => {
        ...
        `;
          window.Email.send({
            ...
            message === "OK" ? setShow(true) : alert(message)
          );
        }
      });
    } else {
        ...
        <tr>
          ...
          <td>
            <input
              ...
              onChange={(e) => sgmail(e.target.value.toLowerCase())}
            />
          </td>
          <td>
            <Button variant="secondary" onClick={Emailverify}>
              verify
            </Button>
          </td>
        </tr>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => sphone(e.target.value.toUpperCase())}
                />
              </td>
            </tr>
            <br />
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => sbranch(e.target.value.toUpperCase())}
                />
              </td>
            </tr>
            <br />
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => ssec(e.target.value.toUpperCase())}
                />
              </td>
            </tr>
            <br />
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => sreg(e.target.value.toUpperCase())}
                />
              </td>
            </tr>
            <br />
